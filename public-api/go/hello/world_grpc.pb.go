...
const (
	HelloWorldService_MyName_FullMethodName = "/hello.HelloWorldService/MyName"
)
...
func (c *helloWorldServiceClient) MyName(ctx context.Context, in *core.Empty, opts ...grpc.CallOption) (*MyNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, HelloWorldService_MyName_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWorldService_MyName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloWorldService_MyName_FullMethodName,
	}
